    ...
    Box (
        ...
        Card( //q1
            colors = CardDefaults.cardColors(
                containerColor = Color(255, 152, 0),
        ...
        Card( //q2
            colors = CardDefaults.cardColors(
                containerColor = Color(127, 39, 255),
        ...
        Card( //q3
            colors = CardDefaults.cardColors(
                containerColor = Color(250, 239, 155),
        ...
        Card( //q4
            colors = CardDefaults.cardColors(
                containerColor = Color(255, 64, 125),
            ),
            shape = RectangleShape,
            modifier = Modifier
                .fillMaxWidth(0.5f)
